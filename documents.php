...
<div class="ianda1">
	<div class="w3-padding floating-box-test" id="myHeader">
		<br>
	<br><br><br><br>
	<div class="centered myfontL">Document & Diagram<br>
  <p class="myfontS">Designs</p></div><br><br><br><br>
	...
	<!-- JIRA CARD -->
		<div class="card">
			...
			<p class="w3-center" style="padding-bottom: 0px; height: 90%; display: flex; align-items: center; justify-content: center;">
					<img src="images/images/jira-workflow-sm.png" class="w3-circle" style="width:200px; margin-bottom: 10px; display: flex; align-items: center; justify-content: center;"
					alt="Avatar">
			</p>

			<div class="details">
				<h2>
				<a href="jiraworkflow.html" target="_blank">JIRA / GIT Workflow</a>
				<br>
					<span>Detailed flow chart for complex process</span>
				</h2>
			</div>
		</div>
		...
		<div class="card">
			<div class="layer"></div>
			<p class="w3-center" style="padding-bottom: 0px; height: 90%; display: flex; align-items: center; justify-content: center;">
				<img src="images/images/ui-flow-sm.png" class="w3-circle"
					style="width:200px;; margin-bottom: 10px; display: flex; align-items: center; justify-content: center;"
					alt="Avatar">
			</p>
			<div class="details">
				<h2>
				<a href="appover.html" target="_blank">APPLICATION WORKFLOW</a>
				<br>
					<span>M&R application device discovery flow chart</span>
				</h2>
			</div>
		</div>
		...
		<div class="card">
			<div class="layer"></div>
			<p class="w3-center" style="padding-bottom: 0px; height: 90%; display: flex; align-items: center; justify-content: center;">
				<img src="images/images/table-polling-sm.png" class="w3-circle"
					style="width:200px; margin-bottom: 10px; display: flex; align-items: center; justify-content: center;"
					alt="Avatar">
			</p>
			<div class="details">
				<h2>
				<a href="table.html" target="_blank">MIB TABLE POLLING</a><br>
					<span>Detailed flow chart for device MIB collection</span>
				</h2>
			</div>
		</div>

		<!-- Customer Boarding CARD -->
		<div class="card">
			<div class="layer"></div>
			<p class="w3-center" style="padding-bottom: 0px; height: 90%; display: flex; align-items: center; justify-content: center;">
				<img src="images/images/boarding-flow-sm.png" class="w3-circle"
					style="width:200px;; margin-bottom: 10px; display: flex; align-items: center; justify-content: center;"
					alt="Avatar">
			</p>
			<div class="details">
				<h2>
				<a href="cust-b.html" target="_blank">CUSTOMER BOARDING</a>
				<br>
					<span>Flow chart for boarding customers</span>
				</h2>
			</div>
		</div>
	...
	<div class="card">
			...
			<!-- div class="cardimg"-->
			<p class="w3-center" style="padding-bottom: 0px; height: 90%; display: flex; align-items: center; justify-content: center;">
				<img src="images/images/solution-pack-sm.png" class="w3-circle"
					style="height:200px;; margin-bottom: 10px; display: flex; align-items: center; justify-content: center;"
					alt="Avatar">
			</p>
			<div class="details">
				<h2>
				<a href="solution.html" target="_blank">M&R SOLUTION PACKS</a>
				<br>
					<span>Workflow for deploying solution packs</span>
				</h2>
			</div>
		</div>
		...
		<div class="carousel-card">
			...
			<p class="w3-center quote-font" style="padding-bottom: 50px; font-size: 40px">
				<!--img src="images/quotes2.png" 
					...
					alt="Avatar"-->
			<i>"Simplify Complexity"</i>
					</p>
			<div class="details">
				<h2>DOCUMENT & DIAGRAMS<br>
					<span>Detailed</span>
				</h2>
			</div>
			</div>
